...
window.DUTCH_I18N = {
  en: {
    ...
    itemsLabel: "Items",
    itemNamePlaceholder: "e.g. Pizza",
    itemPricePlaceholder: "0.00",
    addItemBtn: "+ Add item",
    itemWhoLabel: "Who shares this item?",
    itemTaxBadge: "tax",
    addDeliveryFeeBtn: "+ Delivery fee",
    addTipBtn: "+ Tip",
    addTaxBtn: "+ Sales tax",
    deliveryFeeLabel: "Delivery fee",
    tipLabel: "Tip",
    taxRateLabel: "Sales tax %",
    taxDefaultLabel: "Default sales tax %",
    taxDefaultHint: "Pre-filled when adding sales tax to an itemized expense (e.g. 8.25 for College Station, TX).",
    divideByLabel: "Divide fee & tip by",
    divideByHint: "Total items on the receipt — even ones not entered here. Fee and tip are split per item.",
    taxHint: "Toggle \"tax\" on each item that is taxable.",
    itemizedTotalLabel: "Tracked total",
    itemsBreakdownLabel: "Item breakdown",
    perPersonBreakdown: "Each person owes",
    feeTipPerItem: (v) => `+${v} fee/tip per item`,
    itemsCountUnit: (n) => `${n} item${n !== 1 ? "s" : ""}`,

    // validation
    errRequired: "This is required",
    errTitleRequired: "Give it a name",
    errAmountRequired: "Enter an amount",
    errSplitRequired: "Pick at least one person",
    errNoItems: "Add at least one item",
    errItemName: "Item needs a name",
    errItemPrice: "Item needs a price",
    errItemPeople: "Pick who shares this item",
    errMembersRequired: "Add at least one member",

    // password-gated actions
    pwDeleteExpenseTitle: "Password to delete",
    pwEditExpenseTitle: "Password to edit",
    pwActionHint: "Enter the group password (or the owner password).",
  ...
  ko: {
    ...
    modeItemized: "영수증 입력",
    itemsLabel: "품목",
    itemNamePlaceholder: "예: 피자",
    itemPricePlaceholder: "0.00",
    addItemBtn: "+ 품목 추가",
    itemWhoLabel: "이 품목을 나눌 사람",
    itemTaxBadge: "세금",
    addDeliveryFeeBtn: "+ 배달비",
    addTipBtn: "+ 팁",
    addTaxBtn: "+ 판매세",
    deliveryFeeLabel: "배달비",
    tipLabel: "팁",
    taxRateLabel: "판매세 %",
    taxDefaultLabel: "기본 판매세 %",
    taxDefaultHint: "영수증 입력에서 판매세를 추가할 때 자동으로 채워집니다 (예: 텍사스 College Station 8.25).",
    divideByLabel: "배달비·팁 나눌 개수",
    divideByHint: "영수증의 전체 품목 수 (여기 입력 안 한 품목 포함). 배달비와 팁이 품목당 균등 분배됩니다.",
    taxHint: "과세 품목마다 \"세금\" 토글을 켜주세요.",
    itemizedTotalLabel: "입력된 합계",
    itemsBreakdownLabel: "품목 내역",
    perPersonBreakdown: "1인당 부담액",
    feeTipPerItem: (v) => `+품목당 ${v} (배달비/팁)`,
    itemsCountUnit: (n) => `${n}개 품목`,

    // validation
    errRequired: "필수 항목입니다",
    errTitleRequired: "이름을 입력해주세요",
    errAmountRequired: "금액을 입력해주세요",
    errSplitRequired: "한 명 이상 선택해주세요",
    errNoItems: "품목을 하나 이상 추가해주세요",
    errItemName: "품목 이름을 입력해주세요",
    errItemPrice: "품목 가격을 입력해주세요",
    errItemPeople: "품목을 나눌 사람을 선택해주세요",
    errMembersRequired: "멤버를 한 명 이상 추가해주세요",

    // password-gated actions
    pwDeleteExpenseTitle: "삭제하려면 비밀번호 입력",
    pwEditExpenseTitle: "수정하려면 비밀번호 입력",
    pwActionHint: "그룹 비밀번호(또는 관리자 비밀번호)를 입력하세요.",
